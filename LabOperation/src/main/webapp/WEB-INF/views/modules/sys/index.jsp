...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/statics/thirdparty/layui/css/layui.css">
    <link rel="stylesheet" href="${basePath}/statics/modules/sys/css/layadmin.css">
    <script src="${basePath}/statics/thirdparty/jquery/jquery.min.js"></script>
    <script src="${basePath}/statics/thirdparty/layui/layui.js"></script>
    <link rel="stylesheet" href="../src/css/layui.css">
</head>
<%--<body class="layui-layout-body">--%>
<%--<div class="layui-layout layui-layout-admin">--%>
<%--<div class="layui-header">--%>
<%--<div class="layui-logo">实验室管理系统</div>--%>
...
<%--<a class="" href="javascript:addTab('所有教室');">所有教室</a>--%>
<%--</li>--%>
<%--<li class="layui-nav-item layui-nav-itemed">--%>
<%--<a class="" href="javascript:addTab('文件管理');">文件管理</a>--%>
<%--</li>--%>
<%--<li class="layui-nav-item layui-nav-itemed">--%>
<%--<a class="" href="javascript:addTab('排课管理');">排课管理</a>--%>
<%--</li>--%>
<%--<li class="layui-nav-item layui-nav-itemed">--%>
<%--<a class="" href="javascript:addTab('排课结果');">排课结果</a>--%>
<%--</li>--%>
